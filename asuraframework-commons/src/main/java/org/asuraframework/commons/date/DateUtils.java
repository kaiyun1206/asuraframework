...
public class DateUtils {
    ...
    public static class Builder {
        ...
        private static TemporalField ISO_WEEK_FIELDS = WeekFields.ISO.dayOfWeek();
        ...
        public Builder parse(String dataStr, String pattern) {
            ...
            DateTimeFormatter dateTimeFormatter = new DateTimeFormatterBuilder().append(df1).parseDefaulting(ChronoField.MONTH_OF_YEAR, 1).parseDefaulting(ChronoField.DAY_OF_MONTH, 1).parseDefaulting(ChronoField.HOUR_OF_DAY, 0).parseDefaulting(ChronoField.MINUTE_OF_HOUR, 0).parseDefaulting(ChronoField.SECOND_OF_MINUTE, 0).parseDefaulting(ChronoField.MILLI_OF_SECOND, 0).toFormatter();
        ...
        public Builder with(int year, int monthOfYear, int dayOfMonth, int hourOfDay, int minuteOfHour, int secondOfMinute, int milliOfSecond) {
            ...
            dateTime = dateTime.withYear(year).withMonth(monthOfYear).withDayOfMonth(dayOfMonth).withHour(hourOfDay).withMinute(minuteOfHour).withSecond(secondOfMinute).with(ChronoField.MILLI_OF_SECOND, milliOfSecond);
            return this;
        }
        ...
        public Builder with(int year, int monthOfYear, int dayOfMonth) {
            ...
            dateTime = dateTime.withYear(year).withMonth(monthOfYear).withDayOfMonth(dayOfMonth);
            return this;
        }
        ...
        public Builder withFirstDayOfWeek() {
            ...
            dateTime = dateTime.with(ISO_WEEK_FIELDS, 1);
            return this;
        }
        ...
        public Builder withLastDayOfWeek() {
            ...
            dateTime = dateTime.with(ISO_WEEK_FIELDS, 7);
            return this;
        }
        ...
        public int getDayOfWeek() {
            ...
            return dateTime.get(ISO_WEEK_FIELDS);
        }
